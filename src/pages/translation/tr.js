const infosTr = {
    ...
    name:'Osman Ordu',
    description_p1:'Yenilikçi, esnek ve ölçeklenebilir çözümler geliştirme konusunda başarılıyım. Kullanıcı deneyimini ön planda tutarak estetik ve işlevsellik arasında mükemmel bir denge kurmaya çalışıyorum. Teknolojik gelişmeleri yakından takip ederek, en son trendleri ve en iyi uygulamaları projelerime entegre etmeyi sağlıyorum.',
    description_p2:'Siz de ekip çalışmasına yatkın, yenilikçi ve tutkulu birini ekibe dahil etmek istiyorsanız iletişime geçmekten çekinmeyin. Bana göre kod yalnızca yazılı sembollerin birleşiminden ibaret değil; Gerçek bir şaheser yaratma fırsatı..',
    ...
    experience_2_description_1:'Türkiye´nin önde gelen e-ticaret markalarına kişiye özel e-ticaret hizmeti verildi. Atasay, Koton, Derimod, Bauhaus, Avansas, Panço, Exporgin, Atom Bilişim, Ayakkabı Dünyası, Saat&Saat, Armağan Oyuncak ve Bayar Gold gibi.',
    experience_2_description_2:'Segmentify´ın kişiselleştirilmiş alışveriş deneyimini geliştirmek için kullanıcı dostu ve ilgi çekici arayüzler hazırladı.',
